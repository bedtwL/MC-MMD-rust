    ...
    public static Screen create(Screen parent) {
        ...
        performanceCategory.addEntry(entryBuilder
            .startIntSlider(
                ...
                SkinLayers3DConfig.modelPoolMaxCount.get(), 10, 500)
            .setDefaultValue(100)
            .setTooltip(Component.translatable("gui.skinlayers3d.mod_settings.model_pool_max.tooltip"))
            .setSaveConsumer(value -> SkinLayers3DConfig.modelPoolMaxCount.set(value))
            .build());
